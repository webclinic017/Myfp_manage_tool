...
from Support.KingFund import KingFund
...
class Fund:
    ...
    def __init__(self,
        ...
        self.pool_50 = pool_50
        self.pool_200 = pool_200
        # not init attribute
    ...
    def add_pool_50(self, pool_50: bool):
        self.pool_50 = pool_50

    def add_pool_200(self, pool_200: bool):
        self.pool_200 = pool_200
    ...
    # def get_kingfund_data(self):
        # prices_data = kf.get_fund_code_by_name()
        # self.add_prices_data(prices_data)
