...
class FinancialRatios:
    ...
    def expected_return(data, annual=52):
        return_table = FinancialRatios.return_table(data)
    ...
    def annualised_return(data, annual=52):
        return_table = FinancialRatios.accumulate_return(data)
    ...
    def sharpe(data, annual=52):
        expected_return = FinancialRatios.expected_return(data, annual=annual)
        volatility = FinancialRatios.volatility(data, annual=annual)
    ...
    def excess_return(data, index_data):
        return_table = FinancialRatios.return_table(data)
        index_return_table = FinancialRatios.return_table(index_data)
...
if __name__ == '__main__':
    ...
    return_table = FinancialRatios.excess_return(test, test.iloc[:, 0])
    print(return_table)
    print(type(return_table))

    return_table = FinancialRatios.accumulate_excess_return(test, test.iloc[:, 0])
    print(return_table)
    print(type(return_table))